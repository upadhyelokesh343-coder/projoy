...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-50 flex flex-col pb-20 md:pb-0">
      {/* 3D Sticky Top Header (Visible on Mobile & Desktop) */}
      <header className="sticky top-0 z-50 w-full flex justify-between items-center px-4 md:px-8 py-3 bg-gradient-to-b from-neutral-800 to-neutral-950 border-b border-neutral-800 shadow-[0_4px_20px_rgba(0,0,0,0.5)] backdrop-blur-md">
      ...
      <main className="flex-1 w-full max-w-md mx-auto md:max-w-7xl md:px-6 py-6 md:pb-6 overflow-y-auto overflow-x-hidden">
        {/* Page Content */}
