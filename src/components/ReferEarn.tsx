...
export const ReferEarn = () => {
  ...
  const shareReferral = async () => {
    if (!referralLink) return;
    const shareText = `Join me on ProJoy eSports gaming app! 🎮 Complete your first tournament entry or deposit, and both of us will earn rewards! Sign up here: ${referralLink}`;
    if (navigator.share) {
      try {
        await navigator.share({
          title: 'ProJoy eSports Referral',
          text: shareText,
          url: referralLink,
        });
      } catch (err) {
