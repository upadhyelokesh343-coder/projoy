          ...
          {activeTab === 'signin' ? (
            ...
            <form onSubmit={handleSignInSubmit} className="space-y-4">
              ...
              <div className="relative flex items-center justify-center my-4">
                ...
                <span className="absolute bg-neutral-900 px-3 text-[10px] text-neutral-500 uppercase tracking-widest font-semibold">Or</span>
              </div>
              ...
              <button
                ...
                className="w-full py-2.5 bg-neutral-950 hover:bg-neutral-800 border border-neutral-800 disabled:opacity-50 text-white font-bold text-xs rounded-xl transition-colors"
              >
                Sign in with Google
              </button>
