                ...
                <div className="p-4 flex-1 flex flex-col">
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-3">
                    <div className="bg-neutral-950 rounded-xl p-3 border border-neutral-800/50">
                      <p className="text-xs text-neutral-500 mb-1">{t.type === 'per_kill' ? 'Per Kill' : 'Prize Pool'}</p>
                      <p className="font-bold text-emerald-400">₹{t.type === 'per_kill' ? t.perKillPrize : t.prizePool}</p>
                    </div>
                    <div className="bg-neutral-950 rounded-xl p-3 border border-neutral-800/50">
                  ...
                  {t.type === 'per_kill' ? (
                    <div className="mb-4">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-[10px] uppercase font-bold text-neutral-500 tracking-wider">Format</span>
                      </div>
                      <div className="bg-neutral-900 border border-neutral-800 rounded-lg px-3 py-2 flex items-center gap-2">
                        <span className="text-lg">🎯</span>
                        <div>
                          <p className="text-xs font-bold text-white">Bounty Hunter</p>
                          <p className="text-[10px] text-neutral-400">Earn ₹{t.perKillPrize} for every kill</p>
                        </div>
                      </div>
                    </div>
                  ) : (
